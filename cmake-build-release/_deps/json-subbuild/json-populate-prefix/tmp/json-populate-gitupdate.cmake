...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v3.11.2"
  WORKING_DIRECTORY "/Users/jolluemil/Desktop/cpptasks/search_engine/cmake-build-release/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/jolluemil/Desktop/cpptasks/search_engine/cmake-build-release/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/jolluemil/Desktop/cpptasks/search_engine/cmake-build-release/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
